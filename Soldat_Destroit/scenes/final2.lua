...
local music=audio.loadSound("music/level2fon.mp3")
local musicdefeat
local defeatCount = 0
...
function scene:create(event)
    ...
    local new = composer.getVariable("finalDefeat2Score")
    composer.setVariable("finalDefeat2Score", 0)
end
...
function scene:hide(event)
    ...
    if (phase == "did") then
        ...
        musicdefeat = nil
        composer.removeScene("scenes.final2")
    end
end
